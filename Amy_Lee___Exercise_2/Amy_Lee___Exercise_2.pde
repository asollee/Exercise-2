...
strokeWeight(3);
fill(244, 233, 222);
triangle(-50, 232, 145, -362, 420, 532);

// SMALL BOTTOM TRIANGLE, orange overlap
noStroke();
fill(177, 131, 69, 220);
triangle(0, 312, 287, 104, 351, 312);
...
/* when making arcs:
You start at 0, that's the "starting angle" or where the arc will start
then it goes in the negative direction, clockwise,
then use regular unit circle from there.
"ending angle" is where the arc will end */
//fill(255);
//arc(380, 180, 30, 30, 0 + QUARTER_PI, PI + QUARTER_PI);